import { GridItem, Heading, Button, VStack, Box, Center, Spinner, SimpleGrid, Stack } from '@chakra-ui/react';
    ...
    return (
        <VStack spacing={6} align='start' py={6}>
            <Stack w='full' spacing={{ base: 3, lg: 6 }} direction={{ base: 'row', lg: 'column' }} align={{ base: 'center', sm: 'start' }}>
                <Heading whiteSpace='nowrap' textTransform={{ base: 'none', lg: 'uppercase' }} as='h4' fontSize={{ base: '2xl', lg: 'md' }}>Recently Added</Heading>
                <Box as='hr' w='full' />
            </Stack>
            <SimpleGrid columns={{ base: 1, xs: 2, sm: 3, lg: 1 }} spacing={6} w='full'>
